...
from webapp.views.categories import category_add_view, categories_view, category_edit, category_delete
from webapp.views.products import products_view, product_view, product_add_view
...
urlpatterns = [
    ...
    path("categories/<int:pk>/edit", category_edit, name='category_edit_view'),
    path("categories/<int:pk>", category_delete, name='category_delete')
]
